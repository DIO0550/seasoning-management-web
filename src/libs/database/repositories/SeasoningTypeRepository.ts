/**
 * @fileoverview SeasoningTypeRepositoryクラス
 * コンストラクタ注入パターンで動作する調味料種類リポジトリ
 */
...
/**
 * 調味料種類リポジトリ（コンストラクタ注入パターン）
 */
export class SeasoningTypeRepository implements ISeasoningTypeRepository {
  /**
   * コンストラクタでDB接続を注入
