...
- [ ] `src/constants/database/connectionLimits.ts` - DB 接続制限定数の作成
- [ ] 本番環境接続プール数定数 (10)
- [ ] 開発環境接続プール数定数 (5)
- [ ] テスト環境接続プール数定数 (3)
- [ ] 型定義と JSDoc コメントの追加
...
- [ ] `src/constants/database/timeouts.ts` - タイムアウト関連定数の作成
- [ ] 本番環境タイムアウト定数 (60000ms)
- [ ] 開発環境タイムアウト定数 (30000ms)
- [ ] 型定義と JSDoc コメントの追加
